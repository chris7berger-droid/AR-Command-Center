    ...
    pages: [
      { pg: "2", screen: "Triage Customers", id: "triage",
        ...
        features: [
          ...
          { label: "Customer detail (right panel)", desc: "Aging buckets and invoice list \u2014 just enough context to make a triage call",
            steps: ["1. Click a customer on the left", "2. See their aging breakdown (Current, 1-30, 31-60, 61-90, 91+)", "3. Scroll the invoice list to spot anything off", "4. Make your call using the buttons at the bottom"] },
          { label: "Triage buttons (Good / Unsure / Not Right / Problem)", desc: "Classify the customer and auto-advance to the next untriaged one",
            steps: ["1. Review the customer's invoices and aging", "2. Click one of the four buttons at the bottom:", "   \u2022 Good \u2014 QB is accurate, chase this money", "   \u2022 Unsure \u2014 need to verify before acting", "   \u2022 Not Right \u2014 QB is wrong, accountant needs to fix", "   \u2022 Problem \u2014 dispute, go-back, or legal issue", "3. The next untriaged customer loads automatically", "4. Click the same button again to un-triage a customer"] },
        ],
      },
    ],
  },
